...
ActiveRecord::Schema.define(version: 2018_08_31_080307) do
  ...
  create_table "spree_packs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["available_on"], name: "index_spree_packs_on_available_on"
    t.index ["deleted_at"], name: "index_spree_packs_on_deleted_at"
    t.index ["discontinue_on"], name: "index_spree_packs_on_discontinue_on"
  end
  ...
  create_table "spree_subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["deleted_at"], name: "index_spree_subscriptions_on_deleted_at"
    t.index ["subscriber_id", "variant_id"], name: "index_spree_subscriptions_on_subscriber_id_and_variant_id", unique: true, where: "(deleted_at IS NULL)"
  end
  ...
  add_foreign_key "spree_packs", "spree_variants", column: "variant_id"
  add_foreign_key "spree_subscriptions", "spree_users", column: "subscriber_id"
  add_foreign_key "spree_subscriptions", "spree_variants", column: "variant_id"
